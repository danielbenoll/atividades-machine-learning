...
# utilizamos o método de SVC dando como parâmetro o C = que é a punição por classificação incorreta, juntamente com o kernel "sigmoid"
svm_hepatitis = SVC(kernel='sigmoid', random_state=1, C = 10.0) # Testar com Kernels e C (2 a 4)
