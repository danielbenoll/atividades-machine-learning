...
# utilizamos o método de SVC dando como parâmetro o C = que é a punição por classificação incorreta, juntamente com o kernel "poly"
svm_hepatitis = SVC(kernel='poly', random_state=1, C = 10.0) # Testar com Kernels e C (2 a 4)
